...
class ConfigurationAdapter :
    ListAdapter<UtilityDTO, ConfigurationAdapter.MyViewHolder>(DiffUtilUtilityDTO()) {
    var appOnClick: AppOnClick? = null
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val inflate =
            LayoutInflater.from(parent.context).inflate(R.layout.item_configuration, parent, false)
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(record: UtilityDTO, position: Int) {
            ...
            itemView.tvSubText.text = record.subValue
            appOnClick?.let { _ ->
